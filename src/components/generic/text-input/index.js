...
import { defaultTypography, squadWhite } from '../../../styles'
      ...
      <View style={[dense ? styles.denseWrapper : styles.wrapper, this.state.height ? {height: undefined}: {}, wrapperStyle]} ref="wrapper">
        <TextInput
          style={[dense ? styles.denseTextInput : styles.textInput, {
            ...
            color: textBlurColor
          } : {}, inputStyle, styles.defaultFont,  this.state.height ? {height: this.state.height} : {}]}
          multiline={multiline}
          onFocus={() => {
        ...
        <FloatingLabel
          ...
          style={labelStyle && styles.defaultFont}
        />
      </View>
    );
  }
